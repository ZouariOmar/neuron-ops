...
# Security Policy for neuron-ops

## Supported Versions

The neuron-ops project provides security updates for the following versions:
...
If you discover a security vulnerability in neuron-ops, we encourage responsible disclosure. To report a vulnerability:
...
We appreciate the security community's efforts in helping us maintain neuron-ops’s safety and integrity.

## Security Practices

neuron-ops follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- neuron-ops uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance neuron-ops's security by following these practices:
...
Thank you for helping us make neuron-ops secure for our users and the community!
